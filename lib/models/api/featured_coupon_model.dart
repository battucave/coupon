...
List<FeaturedCouponModel> featuredCouponModelFromJson(String str) => List<FeaturedCouponModel>.from(json.decode(str).map((x) => FeaturedCouponModel.fromJson(x)));

String featuredCouponModelToJson(List<FeaturedCouponModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
