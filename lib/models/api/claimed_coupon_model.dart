...
List<ClaimedCouponModel> claimedCouponModelFromJson(String str) =>
    List<ClaimedCouponModel>.from(
        json.decode(str).map((x) => ClaimedCouponModel.fromJson(x)));

String claimedCouponModelToJson(List<ClaimedCouponModel> data) =>
...
class ClaimedCouponModel {
  ...
  factory ClaimedCouponModel.fromJson(Map<String, dynamic> json) =>
      ClaimedCouponModel(
